...
sharedfilter::sharedfilter(QWidget *parent):
    QDialog(parent)
{
...
//sharedfilter--|
//               --addTab--delTab
void sharedfilter::addMainLayout()
{
...
void sharedfilter::addFilterTitle(int tabIndex)
{
...
void sharedfilter::addEditFilterBtn(int tabIndex)
{
    QWidget *curTabWidget = mainTabWidget->widget(tabIndex);
