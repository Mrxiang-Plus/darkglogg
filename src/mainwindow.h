...
class MainWindow : public QMainWindow {
 ...
 public:
  ...
  QIcon getIcon();
  void setApplication(GloggApp *app);
 ...
 private slots:
  ...
  void changeQMPattern(const QString &newPattern);
